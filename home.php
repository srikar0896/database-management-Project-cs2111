...
echo 'You logged in!';
echo '<br><br>';
echo '<a href="my-media.php"><b>MUSIC</b></a>';
echo '<br><br>';
echo '<a href="friend-s-media.php"><b>FRIEND\'S MEDIA</b></a>';
echo'<br><br>';
echo '<a href="my-videos.php"><b>MY VIDEOS</b></a>';
echo'<br><br>';
echo '<a href="youtube_playlist.php"><b>YOUTUBE PLAYLIST</b></a>';
echo'<br><br>';
echo '<a href="soundcloud_playlist.php"><b>SOUNDCLOUD PLAYLIST</b></a>';
echo'<br><br>';

echo '<a href="profile.php"><b>PROFILE</b></a>';
echo'<br><br>';
